...
# Paths to applications (update as per your system)
...
PREDEFINED_QUERIES = {
    ...
    "what is zero divided by zero": "Imagine that you have zero cookies and you split them evenly among zero friends. How many cookies does each person get? See? It doesn’t make sense.",
    ...
    "what is inception about": "Inception is about dreaming about dreaming about dreaming about something or other. I fell asleep.",
